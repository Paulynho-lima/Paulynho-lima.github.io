  ...
  return (
    <main className='Aboutman'>
      <section className={"sobreText"}>
        ...
        <p>
          Apaixonado por tecnologia sou Bacharelado no curso Sistemas de Informação
          e  formação tecnica em desenvolvimento FrontEnd e BackEnd Junior na escola <a className='trybe' href='https://www.betrybe.com/' target="_blank" data-tooltip="Clik aqui e Saiba Mais.">Trybe</a>,
